                    ...
                    children: [
                      Column(
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Text(
                                    data.isUserProfileLoaded
                                        ? data.userProfileFromJson.result.name
                                        : " ",
                                    style: TextStyle(
                                      color: black,
                                  ...
                                  Text(
                                    data.isUserProfileLoaded
                                        ? data.userProfileFromJson.result
                                            .phoneNumber
                                        : "",
                                    style: TextStyle(
                          ...
                          mainWidget(10, 'Wallet'.tr,
                              "assets/drawer_icons/CashBackIcon.svg"),
                          Container(height: 1,width: Get.width,color: lineColor,),
                          mainWidget(3, 'Settings'.tr,
                              "assets/drawer_icons/SettingsIcon.svg"),
                          Container(height: 1,width: Get.width,color: lineColor,),

                          mainWidget(4, 'Terms and Conditions'.tr,
                              "assets/drawer_icons/TermsIcon.svg"),
                          Container(height: 1,width: Get.width,color: lineColor,),
                          mainWidget(5, 'Invite a friend'.tr,
                              "assets/drawer_icons/InviteIcon.svg"),
                          Container(height: 1,width: Get.width,color: lineColor,),
                          mainWidget(
                              8, 'Help'.tr, "assets/drawer_icons/HelpIcon.svg",
                              scale: 4.5),
                          Container(height: 1,width: Get.width,color: lineColor,),
                          ],
                      ),
                      mainWidget(7, 'Log out'.tr,
                          "assets/drawer_icons/LogoutIcon.svg"),
                    ],
                  ),
                ),
              ),
