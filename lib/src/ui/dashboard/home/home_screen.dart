          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Image.asset("assets/home_assets/wave.png", scale: .6).paddingOnly(right: 20),
              ],
            ),
            SizedBox(height: 10),
            Expanded(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              ...
                              onTap: () {
                                bottomForComingSoon(
                                    "خدمة بنشر الكفرات", "هذه الخدمة ستتوفر قريباً");
                              },
                              child: Column(
                                children: [
                                  Container(
                            ...
                            Expanded(
                              ...
                              onTap: () {
                                bottomForComingSoon(
                                    "خدمة زينة السيارة", "هذه الخدمة ستتوفر قريباً");
                              },
                              child: Column(
                                children: [
                                  Container(
