...
class StaticStrings extends Translations {
  ...
  final Map<String, String> ar = {
    ...
    "Ok": "انهاء",
    "Pay by credit": "دفع بالبطاقة",
    "Add a coupon": "كود الخصم",
    "Coupon code here.": "ضع هنا كود الخصم",
    "Use Coupon code": "استخدم كود خصم",
    ...
    "This service will be available so soon.\n"
        ...
        "ستتوفر قريباً هذه الخدمة نختبر حالياً السطحات لتقديم افضل خدمة لنقل سيارتك",
    "Pickup service": "خدمة السطحة",
    "Congratulations 🎉, your car is fixed, please get your car and check it before you leave.":
        "مبروووك سيارتك صارت جاهزه! فضلاً توجه للورشة لاستلامها",
    "Deal, now you can relax and wait till the workshop complete fixing.":
        "تم الاتفاق ✅ الآن يمكنك متابعة الطلب حتى تنتهي الورشة من صيانة سيارتك",
    "Please go to the workshop and let him check your can to confirm the deal":
        "فضلاً توجه الى الورشة ليتم فحص السيارة والاتفاق",
    "We are looking for the best workshops offer for you, please wait":
        "جاري البحث عن أفضل العروض المناسبة لك، فضلاً انتظر قليلاً",
    ...
    "you have to add a comment to let the workshop catch your issue easily.":
        "يجب عليك إضافة تعليق للسماح للورشة بالتعرف على مشكلتك بسهولة.",
    "SAR": "ر.س",
    ...
    "the_password_must_be_7_characters_or_more":
        "يجب ان يكون الرقم السري 7 أحرف أو أكثر",
    ...
    "You can now order our pickup service to help you bring your car to the workshop":
        "تستطيع الآن طلب سطحة لنقل سيارتك من مكانك إلى مركز الصيانة المحدد.",
    ...
    "Client has paid by credit to Musan, Please Wait for 10 minutes to transfer the amount to you":
        "قام العميل بالدفع عن طريق البطاقة لمصان، يرجى الانتظار لمدة 10 دقائق لتحويل المبلغ إليك",
    "PDF": "عرض",
    ...
    "Chat": "محادثة",
    "Call": "إتصال",
    "call now and talk to our representative":
        "اتصل الآن وتحدث إلى خدمة العملاء",
    ...
    "you are requested to pay down payment before staring work!":
        "تم طلب دفع دفعة مقدمة قبل البدء في الإصلاح",
    ...
    "Thank you!": "شكرا لك",
    "Your offer is under review. Please wait for up to 24 hr for Musan team to reply.":
        "عرضك قيد المراجعة. يرجى الانتظار 24 ساعة وسيقوم فريق مصان بالرد عليكم",
    ...
    "Percentage can't be greater then 100":
        "لا يمكن أن تكون النسبة المئوية أكبر من 100",
    "Missing Info": "معلومات غير متوفرة",
    "Please select/complete all required fields":
        "يرجى تحديد / استكمال جميع الحقول المطلوبة",
    ...
    "you have complected all steps successfully. Please wait for up to":
        "لقد أنهيت جميع الخطوات بنجاح. يرجى الانتظار حتى",
    ...
    "Arrived": "وصلت",
    "The order has been completed, thank you please keep in touch":
        "شكراً لاتمام طلبك من مصان، درب السلامة",
    ...
    "Elite": "فئة النخبة",
    "Coming soon": "قريبا",
    "Please wait, A technician is coming to you.":
        "الفني في الطريق اليك، فضلاً انتظر",
    "A technician is arrived and checking your car.":
        "لقد وصل الفني لموقعك، سيبدأ الفني بفحص السيارة",
    "Congratulations 🎉, your report has been written":
        "مبروك 🎉 ، تم كتابة التقري  يمكنك طلب ورشة عبر التقرير الآن",
    "We are looking for the best technician for you, please wait":
        "نحن نبحث عن أفضل فني لك ، يرجى الانتظار",
    "Waiting": "منتظر",
    ...
    "Add part": "أضف قطعة",
    "Client has not accepted Edits Pending yet":
        "لم يقبل العميل التعديلات المعلقة بعد",
    "Client has not accepted Down Payment yet":
        "لم يقبل العميل الدفعة المقدمة حتى الآن",
    "Set the down payment": "حدد الدفعة الأولى",
    "Edit down payment": "تعديل الدفعة المقدمة",
    "Edit time and cost": "تعديل المدة والتكلفة",
    "Warning": "تحذير",
    "Car Pick up in progress. You can't make any changes until car pick complete":
        "السطحة في الطريق، لا تستطيع التغيير حتى وصول السطحة",
    "Ask Advance Payment": "طلب دفعة مقدمة",
    "Work is finished! Please enter the amount that you received.":
        "انتهى العمل! الرجاء إدخال المبلغ الذي تلقيته.",
    "Services": "الخدمات",
    ...
    "we will send you a SMS code to verify your number":
        "سنرسل لك رمز برسالة نصية قصيرة للتحقق من رقمك",
    ...
    "Rate Now": "قيم الآن",
    "We did a very good job the last time, order again now to enjoy our excellent services!":
        "لا تترد في طلب الخدمة مرة أخرى، أنت عميلنا وحنا بخدمتك بأي وقت، أطلب الآن",
    "Let’s do business again!": "يلا أطلب مرة ثانية",
    "Workshop location": "موقع الورشة",
    "Part cost": "تكلفة القطع",
    "Order #": "رقم الطلب",
    "It seems that you don’t have any active order yet, click on the button below to make your first order now.":
        "هلا وسهلاً فيك نورت مصان، تفضل بتقديم طلبك الأول، فريقنا بخدمتك دائماً",
    "There's no order yet!": "لا يوجد طلب حتى الآن!",
    "Special Offer": "عرض خاص",
    "You can take up to 20% off if you use our app to find your mechanic.":
        "يمكنك الحصول على خصم يصل إلى 20٪ إذا كنت تستخدم تطبيقنا للعثور على الورشة المناسبة لك.",
    ...
    "Call our verified technician to get help ":
        "اتصل بمهندس مصان للحصول على المساعدة المجانية",
    "Call Now": "اتصل الان",
    ...
    "You can now track your order status on the order details screen":
        "يمكنك الآن تتبع حالة طلبك على شاشة تفاصيل الطلب",
    "Back Home": "العودة إلى الشاشة الرئيسية",
    "Special Discount Offer Coming Soon!":
        "قريباً سيتم ارسال عروض خصم لكم، ترقبو...",
    "Your Offers": "عروضك",
    ...
    "Please rate and comment this workshop":
        "يرجى التقييم وإضافة تعليق لخدمة الورشة",
    "Rate": "تقييم",
    "Feedback": "رأي العميل",
    ...
    "Facilitating agreements between clients and workshops":
        "تسهيل الاتفاقيات بين العملاء والورش",
    "The client can follow the maintenance process from his home":
        "يمكن للعميل متابعة عملية الصيانة من منزله",
    "Receipt and delivery of the order without meeting":
        "استلام وتسليم الطلب دون الحاجة لمقابلة الورشة",
    ...
    "We will send a verification code to your mobile number.":
        "سوف نرسل رمز التحقق إلى رقم جوالك.",
    "Confirm": "تقييم",
    "Change mobile number": "تغيير رقم الجوال",
    "We’ve sent a code to a mobile number ending on **11":
        "لقد أرسلنا رمزًا إلى رقم الجوال الذي ينتهي بـ ** 11",
    ...
    "Hello Clients! We are glad to inform you..":
        "مرحبا عملائنا الكرام، يسعدنا إبلاغكم .. ",
    ...
    "Ask us a question or report an issue here":
        "اسألنا سؤالاً أو أبلغ عن مشكلة",
    ...
    "Client wants to negotiate\n the offer for":
        "العميل يرغب في التفاوض على العرض",
    "Order ID": "الطلب رقم",
