...
class OrderOfferScreen extends StatefulWidget {
  ...
  const OrderOfferScreen(this.result, {Key key}) : super(key: key);

  @override
  _OrderOfferScreenState createState() => _OrderOfferScreenState(result);
}

class _OrderOfferScreenState extends State<OrderOfferScreen> {
  final   Result   result;

  _OrderOfferScreenState(this.result);
  ...
  void initState() {
    super.initState();
    analytics.logScreenView(screenName: "OrderOfferScreen",screenClass:"OrderOfferScreen");
  ...
  Widget acceptOffer( int index) {
    ...
    ApiServices.acceptOffer(context, result.offers[index].offerId.toString(), result.offers, result.orderId.toString(),result.offers[index].workshopId.toString());
  }
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        ...
                        Get.to(ChatRoom(chatRoomId:"${dashboardProvider.userID}_${result.workshopId}_${result.orderId}",messageSendBy: result.userId.toString()));
